...
print total_df2
# In[13]:
#total_df2['WT'].to_frame().boxplot()

# new_total_df2 = pd.DataFrame()
# new_total_df2.append(total_df2[0:3]).append(total_df2[7:20])
# new_total_df2.boxplot()

#total_df2.iloc[:, 0:20].boxplot()
#total_df2['BT'].to_frame().boxplot()
#plt.show()

# print total_df.describe()
#print total_df2['WT'].describe()


# total_df['Weight peak/Compaction'].to_frame().boxplot()
# print total_df['Weight peak/Compaction'].describe()
# plt.show()

# In[14]:


# #plot_columns(total_df, ['Infeed shutter open', 'Infeed shutter close', 'Infeed shutter close. delay mode',
#                         'Compactor shutter open', 'Compactor shutter close', 'Compactor move delay'])
# #plot_columns(total_df,
#              ['Bottle weight', 'Cleaning time.', 'Inverter operating time', 'Inverter current peak/Reset/60Hz',
#               'Inverter current peak/Reset/75Hz', 'Inverter current peak/60Hz', 'Inverter current peak/75Hz',
#               'Weight peak/Reset', 'Weight peak/Compaction'])
# #plot_columns(total_df2, labels)

# In[15]:

plt.hist(total_df2['sensor'])
plt.show()
# total_df2.boxplot()
# plt.show()
